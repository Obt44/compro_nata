...
<head>
    ...
    <title>Portfolio - Nata Tech</title>
    ...
    <main class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h1 class="text-4xl font-bold text-gray-900 mb-4">Portfolio Kami</h1>
                <p class="text-lg text-gray-600 max-w-3xl mx-auto">Lihat proyek-proyek yang telah kami kerjakan.</p>
            </div>
