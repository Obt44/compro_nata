...
<head>
    ...
    <title>{{ $portfolio->title }} - Nata Tech</title>
    ...
    <main class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="flex mb-8" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="{{ route('portfolio') }}" class="text-gray-700 hover:text-blue-600">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-gray-500 md:ml-2">{{ $portfolio->title }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            @if ($relatedPortfolios->count() > 0)
                <div class="mt-16">
                    <h2 class="text-2xl font-bold text-gray-900 mb-8">Portfolio Terkait</h2>
