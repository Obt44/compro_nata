        ...
        <form action="{{ route('admin.team.update', $teamMember->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $teamMember->name) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
                </div>

                <!-- Jabatan -->
                <div class="col-span-2 md:col-span-1">
                    <label for="position" class="block text-sm font-medium text-gray-700 mb-1">Jabatan <span class="text-red-500">*</span></label>
                    <input type="text" name="position" id="position" value="{{ old('position', $teamMember->position) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="flex items-center">
                        <div class="mr-4">
                            <div id="photo-preview" class="h-32 w-32 bg-gray-200 rounded flex items-center justify-center overflow-hidden">
                                @if($teamMember->photo)
                                    <img src="{{ asset('storage/' . $teamMember->photo) }}" class="h-32 w-32 object-cover rounded" alt="{{ $teamMember->name }}">
                                @else
                            ...
                            @if($teamMember->photo)
                                <div class="mt-2">
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="remove_photo" class="form-checkbox h-4 w-4 text-blue-600">
                                        <span class="ml-2 text-sm text-gray-700">Hapus foto saat ini</span>
                                    </label>
                                </div>
                            @endif
                        </div>
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center">
                            <input type="radio" name="active" id="active-yes" value="1" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300" {{ old('active', $teamMember->active) == 1 ? 'checked' : '' }}>
                            <label for="active-yes" class="ml-2 text-sm text-gray-700">Aktif</label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" name="active" id="active-no" value="0" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300" {{ old('active', $teamMember->active) == 0 ? 'checked' : '' }}>
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="number" name="order" id="order" value="{{ old('order', $teamMember->order) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" min="0">
                    <p class="text-xs text-gray-500 mt-1">Urutan tampilan (opsional)</p>
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <div id="portfolio-items">
                        @if($teamMember->portfolio && count($teamMember->portfolio) > 0)
                            @foreach($teamMember->portfolio as $item)
                                <div class="portfolio-item mb-2 flex items-center">
                                    <input type="text" name="portfolio[]" value="{{ $item }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan item portofolio">
