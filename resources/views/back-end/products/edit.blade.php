    ...
    <div class="container mx-auto py-8 px-4">
        <div class="bg-white rounded-lg shadow-md p-6 max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-800">Edit Produk/Layanan</h1>
            ...
            <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="meta_description" name="meta_description" rows="3"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Deskripsi singkat untuk preview (maksimal 500 karakter)">{{ old('meta_description', $product->meta_description) }}</textarea>
                        ...
                        <div>
                            ...
                            <select id="status" name="status"
                                ...
                                <option value="retired"
                                    {{ old('status', $product->status) === 'retired' ? 'selected' : '' }}>Retired</option>
                            </select>
                            ...
                            @if ($product->featured_image)
                                <div class="mb-4">
                                    ...
                                    <img src="{{ asset('storage/' . $product->featured_image) }}"
                                        alt="{{ $product->title }}" class="h-48 object-cover rounded-md border">
                                </div>
                            @endif
                ...
                <div class="mt-6">
                    ...
                    <textarea id="content" name="content" rows="8"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Masukkan deskripsi lengkap produk/layanan..." required>{{ old('content', $product->content) }}</textarea>
